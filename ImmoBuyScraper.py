...
class ImmoBuyScraper:
    def __init__(self, url, output_path="data/immo24/buy"):
        self.url = url
    ...
    def extract_all_links(self):
        ...
        for _ in range(total_n_pages):
            ...
            try:
                ...
                time.sleep(5)
            if current_n_page == total_n_pages:
                break
    ...
    def get_label_elements(self, data):
        ...
        for l in label_elements:
            ...
            if v_key == "is24qa-energieeffizienzklasse":
                data[l.text] = self.driver.find_element(By.XPATH, '//*[@class="energy-efficiency-class"]/img').get_attribute("alt")
            else:
